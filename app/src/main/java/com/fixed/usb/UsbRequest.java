...
/**
 * A class representing USB request packet. This can be used for both reading
 * and writing data to or from a
 * {@link android.hardware.usb.UsbDeviceConnection}. UsbRequests can be used to
 * transfer data on bulk and interrupt endpoints. Requests on bulk endpoints can
 * be sent synchronously via {@link UsbDeviceConnection#bulkTransfer} or
 * asynchronously via {@link #queue} and {@link UsbDeviceConnection#requestWait}
 ...
 * {@link UsbDeviceConnection#controlTransfer} for endpoint zero requests
 * instead.
 */
...
public class UsbRequest {
     ...
     * endpoint. Whether the request allows reading or writing depends on the
    ...
    /**
     * Returns the endpoint for the request, or null if the request is not
     * opened.
     *
    ...
    /**
     * Returns the client data for the request. This can be used in conjunction
     * with {@link #setClientData} to associate another object with this
    ...
    /**
     * Sets the client data for the request. This can be used in conjunction
     * with {@link #getClientData} to associate another object with this
     * request, which can be useful for maintaining state between calls to
     * {@link #queue} and
     * {@link android.hardware.usb.UsbDeviceConnection#requestWait}
     *
    ...
    /**
     * Queues the request to send or receive data on its endpoint. For OUT
     * endpoints, the given buffer data will be sent on the endpoint. For IN
     * endpoints, the endpoint will attempt to read the given number of bytes
     * into the specified buffer. If the queueing operation is successful, we
     * return true and the result will be returned via
     * {@link android.hardware.usb.UsbDeviceConnection#requestWait}
     *
